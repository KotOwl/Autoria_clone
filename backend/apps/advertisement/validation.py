FORBIDDEN_WORDS = ["4r5e", "5h1t", "5hit", "a55", "anal", "anus", "ar5e", "arrse", "arse", "ass", "ass-fucker", "asses",
                   ...
                   "mothafucka", "mothafuckas", "mothafuckaz", "mothafucked", "mothafucker", "mothafuckers",
                   ...
                   "orgasim", "orgasims", "orgasm", "orgasms", "p0rn", "pawn", "pecker", "penis", "penisfucker",
                   "phonesex", "phuck", "phuk", "phuked", "phuking", "phukked", "phukking", "phuks", "phuq",
                   "pigfucker", "pimpis", "piss", "pissed", "pisser", "pissers", "pisses", "pissflaps", "pissin",
                   "pissing", "pissoff", "poop", "porn", "porno", "pornography", "pornos", "prick", "pricks", "pron",
                   "pube", "pusse", "pussi", "pussies", "pussy", "pussys", "rectum", "retard", "rimjaw", "rimming",
                   ...
                   "shitdick", "shite", "shited", "shitey", "shitfuck", "shitfull", "shithead", "shiting", "shitings",
                   "shits", "shitted", "shitter", "shitters", "shitting", "shittings", "shitty", "skank", "slut",
                   "sluts", "smegma", "smut", "snatch", "son-of-a-bitch", "spac", "spunk", "s_h_i_t", "t1tt1e5",
                   ...
                   "wang", "wank", "wanker", "wanky", "whoar", "whore",'kys', "willies", "willy", "xrated", "xxx", "хуй",
                   "пизда", "єбати", "блять", "сука", "піздець", "на хуй",
                   "іди на хуй", "хуйня", "хуйово", "охуєнний", "йобаний", "мудак",
                   "лайно", "гівно", "дупа", "срака", "курва", "лярва", "виродок",
                   "покидьок", "наволоч", "сволота", "недолюдок", "дебіл", "ідіот",
                   "йолуп", "дідько", "блін", "трясця"]


def validate_ads(data: dict):
    # price = data.get('price')
    # car_year = data.get('car_year')
    description = data.get('description_of_car', '')

    # if price is None or float(price) < 300 or float(price) > 1_000_000:
    #     return False, "Нереалістична ціна"
    #
    # if car_year is None or int(car_year) < 1980:
    #     return False, "Надто старий рік автомобіля"

    if len(description) < 30:
        return False, "Опис занадто короткий або неінформативний"

    lowered = description.lower()
    for word in FORBIDDEN_WORDS:
        if word in lowered:
            return False, f"Опис містить заборонене або неформальне слово: «{word}»"
